...
namespace ReframeCoreTests
{
    ...
    public class CollectionPropertyNodeTests
    {
        ...
        public void NodeCreation_CreatedReactiveNode_ObtainedIdentifier()
        {
            ...
            //Act
            CollectionPropertyNode partsNode = defaultFactory.CreateNode(whole.Parts, "A") as CollectionPropertyNode;
        ...
        public void HasSameIdentifier_NodesPointingAtTheSameObjectAndMember_ReturnsTrue()
        {
            ...
            CollectionPropertyNode node1 = new CollectionPropertyNode(whole.Parts, memberName);
            CollectionPropertyNode node2 = new CollectionPropertyNode(whole.Parts, memberName);
        ...
        public void HasSameIdentifier_NodesPointingAtSameObjectAndDifferentMember_ReturnsFalse()
        {
            ...
            CollectionPropertyNode node1 = new CollectionPropertyNode(whole.Parts, memberName);
            CollectionPropertyNode node2 = new CollectionPropertyNode(whole.Parts, memberName2);
        ...
        public void HasSameIdentifier_NodesPointingAtDifferentObjectAndSameMember_ReturnsFalse()
        {
            ...
            CollectionPropertyNode node1 = new CollectionPropertyNode(whole1.Parts, memberName);
            CollectionPropertyNode node2 = new CollectionPropertyNode(whole2.Parts, memberName);
        ...
        public void AddPredecessor_GivenAnotherValidPropertyNode_ReturnsTrue()
        {
            ...
            INode node = new CollectionPropertyNode(whole.Parts, memberName);
        ...
        public void AddPredecessor_GivenAnotherValidCollectionNode_ReturnsTrue()
        {
            ...
            INode node = new CollectionPropertyNode(wholes, memberName);
            INode predecessorNode = new CollectionPropertyNode(parts, memberName);
        ...
        public void AddSuccessor_GivenAnotherValidCollectionNode_ReturnsTrue()
        {
            ...
            INode node = new CollectionPropertyNode(wholes, memberName);
            INode successorNode = new CollectionPropertyNode(parts, memberName);
        ...
        public void HasPredecessor_GivenNodeAddedAsSuccessor_ReturnsTrue()
        {
            ...
            INode successorNode = new CollectionPropertyNode(whole.Parts, memberName);
        ...
        public void HasSuccessor_GivenNodeAddedAsPredecessor_ReturnsTrue()
        {
            ...
            INode predecessorNode = new CollectionPropertyNode(whole.Parts, memberName);
