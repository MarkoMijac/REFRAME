    ...
    public partial class DependencyGraphTests
    {
        ...
        */
        ...
        private Order_8_2 CreateCase_8_2()
        {
            ...
            var graph = GraphRegistry.Instance.CreateGraph("GRAPH_8_2");
        ...
        */
        ...
        {
            GraphRegistry.Instance.Clear();
            var graph = GraphRegistry.Instance.CreateGraph("GRAPH_8_3");
        ...
        public void PerformUpdate_Case_8_3_PerformCompleteUpdate_SchedulesCorrectUpdateOrder()
        {
            ...
            var graph = GraphRegistry.Instance.GetGraph("GRAPH_8_3");
        ...
        * Kolekcijski čvor je među-čvor (intermediary node)
        ...
        {
            GraphRegistry.Instance.Clear();
            var graph = GraphRegistry.Instance.CreateGraph("GRAPH_8_4");
        ...
        public void PerformUpdate_Case_8_4_PerformCompleteUpdate_SchedulesCorrectUpdateOrder()
        {
            ...
            var graph = GraphRegistry.Instance.GetGraph("GRAPH_8_4");
        ...
        * Kolekcijski čvor je među-čvor (ne može biti izvorišni čvor).
        ...
        {
            GraphRegistry.Instance.Clear();
            var graph = GraphRegistry.Instance.CreateGraph("GRAPH_8_5");
        ...
        public void PerformUpdate_Case_8_5_PerformCompleteUpdate_SchedulesCorrectUpdateOrder()
        {
            ...
            var graph = GraphRegistry.Instance.GetGraph("GRAPH_8_5");
        ...
        * Kolekcijski čvor je među-čvor (intermediary node)
        ...
        {
            GraphRegistry.Instance.Clear();
            var graph = GraphRegistry.Instance.CreateGraph("GRAPH_8_6");
        ...
        public void PerformUpdate_Case_8_6_PerformCompleteUpdate_SchedulesCorrectUpdateOrder()
        {
            ...
            var graph = GraphRegistry.Instance.GetGraph("GRAPH_8_6");
        ...
        {
            GraphRegistry.Instance.Clear();
            var graph = GraphRegistry.Instance.CreateGraph("GRAPH_8_7");
        ...
        public void PerformUpdate_Case_8_7_PerformCompleteUpdate_SchedulesCorrectUpdateOrder()
        {
            ...
            var graph = GraphRegistry.Instance.GetGraph("GRAPH_8_7");
        ...
        {
            GraphRegistry.Instance.Clear();
            var graph = GraphRegistry.Instance.CreateGraph("GRAPH_8_8");
        ...
        public void PerformUpdate_Case_8_8_PerformCompleteUpdate_SchedulesCorrectUpdateOrder()
        {
            ...
            var graph = GraphRegistry.Instance.GetGraph("GRAPH_8_8");
