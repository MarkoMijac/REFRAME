...
{
    public partial class FrmNamespaceLevelAnalysis : FrmAnalysis
    {
        public FrmNamespaceLevelAnalysis(string reactorIdentifier) : base(reactorIdentifier)
        {
            InitializeComponent();
            AddColumns();
        }
        ...
        {
            Text = $"Namespace-level analysis for Reactor [{ReactorIdentifier}]";
            ShowDescription($"Namespace-level analysis for Reactor [{ReactorIdentifier}]");
        }
