...
{
    public class ClassVisualGraphDGML : VisualGraphDGML
    {
        public ClassVisualGraphDGML(string reactorIdentifier, IEnumerable<IAnalysisNode> analysisNodes)
            : base(reactorIdentifier, analysisNodes)
        {
