...
{
    [TestClass]
    public class UpdateGraphFactoryDGML_Tests
    {
        [TestMethod]
        ...
        [TestMethod]
        public void CreateGraph_GivenValidParameters_ReturnsUpdateGraph()
        {
            //Arrange
            var factory = new UpdateGraphFactoryDGML();
            ...
            //Assert
            Assert.IsTrue(graph != null && graph.GetType() == typeof(UpdateVisualGraphDGML));
        }
    }
}
