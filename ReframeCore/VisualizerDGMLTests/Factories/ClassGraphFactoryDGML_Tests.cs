...
{
    [TestClass]
    public class ClassGraphFactoryDGML_Tests
    {
        [TestMethod]
        ...
        [TestMethod]
        public void CreateGraph_GivenValidParameters_ReturnsClassGraph()
        {
            //Arrange
            var factory = new ClassGraphFactoryDGML();
            ...
            //Assert
            Assert.IsTrue(graph != null && graph.GetType() == typeof(ClassVisualGraphDGML));
        }
    }
}
