...
{
    [TestClass]
    public class AssemblyGraphFactoryDGML_Tests
    {
        [TestMethod]
        ...
        [TestMethod]
        public void CreateGraph_GivenValidParameters_ReturnsAssemblyGraph()
        {
            //Arrange
            var factory = new AssemblyGraphFactoryDGML();
            ...
            //Assert
            Assert.IsTrue(graph != null && graph.GetType() == typeof(AssemblyVisualGraphDGML));
        }
    }
}
