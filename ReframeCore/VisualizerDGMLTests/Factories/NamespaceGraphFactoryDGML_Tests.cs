...
{
    [TestClass]
    public class NamespaceGraphFactoryDGML_Tests
    {
        [TestMethod]
        ...
        [TestMethod]
        public void CreateGraph_GivenValidParameters_ReturnsNamespaceGraph()
        {
            //Arrange
            var factory = new NamespaceGraphFactoryDGML();
            ...
            //Assert
            Assert.IsTrue(graph != null && graph.GetType() == typeof(NamespaceVisualGraphDGML));
        }
    }
}
