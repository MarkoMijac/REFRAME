...
{
    [TestClass]
    public class ObjectMemberGraphFactoryDGML_Tests
    {
        [TestMethod]
        ...
        {
            //Arrange
            var factory = new ObjectMemberGraphFactoryDGML();
        ...
        [TestMethod]
        public void CreateGraph_GivenValidParameters_ReturnsObjectMemberGraph()
        {
            //Arrange
            var factory = new ObjectMemberGraphFactoryDGML();
            ...
            //Assert
            Assert.IsTrue(graph != null && graph.GetType() == typeof(ObjectMemberVisualGraphDGML));
        }
    }
}
